...
#endif
#if defined(adi7108)&&defined(ST_7108)             /* ADI7108 board based on 7108               */
#include "adi7108_7108.h"
#endif
#if defined(hdk5289)&&defined(ST_5206)             /* HDK5289 board based on 5206               */
#include "hdk5289_5206.h"
#endif
#if defined(hdk5251)&&defined(ST_5206)             /* HDK5251 board based on 5206               */
#include "hdk5251_5206.h"
#endif
#if defined(hdk7106)&&defined(ST_7106)             /* HDK7106 board based on 7106               */
#include "hdk7106_7106.h"
#endif
#if defined(hdk7108)&&defined(ST_7108)             /* HDK7108 board based on 7108               */
#include "hdk7108_7108.h"
#endif
...
#endif
#if defined(hdk7167)&&defined(ST_7105)             /* HDK7167 Platform for STx7167              */
#include "hdk7167_7105.h"
#endif
#if defined(hdk7197)&&defined(ST_7105)             /* HDK7197 Platform for STx7197              */
#include "hdk7197_7105.h"
#endif
#if defined(kourou)&&defined(ST_7105)               /* KOUROU Platform for 7105               */
#include "kourou_7105.h"
#endif
#if defined(hdkh251)&&defined(ST_7105)             /* HDKH251 Platform for STx7197              */
#include "hdkh251_7105.h"
#endif
...
#endif
#if defined(mb903)&&defined(ST_7108)               /* MB903 Platform for STx7108                */
#include "mb903_7108.h"
#endif
#if defined(hdk7108)&&defined(ST_H205)             /* hdk7108 Platform for STxH205              */
#include "hdk7108_h205.h"
#endif
#if defined(hdkh205)&&defined(ST_H205)             /* hdkh205 Platform for STxH205              */
#include "hdkh205_h205.h"
#endif
...
#endif
#if defined(isdb7102)&&defined(ST_7105)             /* ISDB7102 Platform for STx7102            */
#include "isdb7102_7105.h"
#endif
...
#endif
#if defined(custom001038)&&defined(ST_7105)        /* Custom001038 Platform for STx7167         */
#include "custom001038_7105.h"
#endif
#if defined(custom001039)&&defined(ST_7141)        /* Custom001039 Platform for STx7141         */
#include "custom001039_7141.h"
#endif
...
#endif
#if defined(custom002007)&&defined(ST_7105)        /* Custom002007 Platform for STx7105         */
#include "custom002007_7105.h"
#endif
#if defined(custom002008)&&defined(ST_7141)        /* Custom002008 Platform for STx7141         */
#include "custom002008_7141.h"
#endif
...
#endif
#if defined(custom003015)&&defined(ST_7108)        /* Custom003015 Platform for STx7108         */
#include "custom003015_7108.h"
#endif
#if defined(custom003016)&&defined(ST_7141)        /* Custom003016 Platform for STx7141         */
#include "custom003016_7141.h"
#endif
...
#endif
#if defined(custom005002)&&defined(ST_7111)        /* Custom005002 Platform for STx7111         */
#include "custom005002_7111.h"
#endif
...
#endif
#if defined(custom022001)&&defined(ST_7141)        /* Custom021001 Platform for STx7141         */
#include "custom022001_7141.h"
#endif
...
#include "mb618.h"
#elif defined(hdk7111)  /* HDK7111 Evaluation Platform for STx7111 */
#include "hdk7111.h"
#elif defined(mb680)  /* MB680 Evaluation Platform for STx7105 */
#include "mb680.h"
#elif defined(hdk7105) /* hdk7105 Evaluation Platform for STx7105 */
#include "hdk7105.h"
#elif defined(hdk7197) /* hdk7197 Evaluation Platform for STx7105 */
#include "hdk7197.h"
#elif defined(hdkh251) /* hdkh251 Evaluation Platform for STx7105 */
#include "hdkh251.h"
#elif defined(hdk7106) /* hdk7106 Evaluation Platform for STx7106 */
#include "hdk7106.h"
#elif defined(hdk7108) /* hdk7108 Evaluation Platform for STx7108 */
#include "hdk7108.h"
#elif defined(hdkh205) /* hdk7108 Evaluation Platform for STx7108 */
#include "hdkh205.h"
#elif defined(mb796)  /* MB796 Evaluation Platform for STx5206 */
#include "mb796.h"
#elif defined(hdk5289) /* hdk5289 Evaluation Platform for STx5206 */
#include "hdk5289.h"
#elif defined(mb628)  /* MB628 Evaluation Platform for STx7141 */
#include "mb628.h"
#elif defined(eud7141) /* EUD7141 Platform for STx7141              */
#include "eud7141.h"
#elif defined(mb704)  /* MB704 Evaluation Platform for STx5197 */
#include "mb704.h"
#elif defined(hdk5189)  /* HDK5189 Evaluation Platform for STx5197 */
#include "hdk5189.h"
#elif defined(mb676)  /* MB676 Evaluation Platform for STx5197/STx5189 */
#include "mb676.h"
#elif defined(mb837)  /* MB837 Evaluation Platform for STx7108 */
#include "mb837.h"
#elif defined(mb903)  /* MB903 Evaluation Platform for STx7108 */
#include "mb903.h"
...
#include "sti7108.h"
#elif defined(ST_H205)    /* STiH205 device */
#include "stih205.h"
...
#if !defined(STTHIS_CPU)
#define STTHIS_CPU          0
#endif
#if !defined(STOTHER_CPU)
#define STOTHER_CPU         0
#endif
#endif /* __STDEVICE_H */
